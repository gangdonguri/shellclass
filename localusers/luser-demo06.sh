...
# (Inside the scipt they are parameters, outside they are arguments.)
NUMBER_OF_PARAMETERS="${#}"
echo "You supplied ${NUMBER_OF_PARAMETERS} argumnets(s) on the command line."

# Make sure they at least supply on arguments.
